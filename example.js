	  ...
	  var tets_alloc = new Uint8Array(Module.HEAPU8.buffer, hposptr, idata.length*idata.BYTES_PER_ELEMENT*10);

	  //console.log(hpos_alloc);
	  //console.log(tets_alloc);
	  ...
	  var pos = new Float32Array(hpos_alloc.buffer, hpos_alloc.byteOffset, hpos_alloc.length);
